package com.sm.myapp.repository;

import com.sm.myapp.JhproductApp;
import com.sm.myapp.config.Constants;
import com.sm.myapp.config.audit.AuditEventConverter;
import com.sm.myapp.domain.PersistentAuditEvent;
...
import static com.sm.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
